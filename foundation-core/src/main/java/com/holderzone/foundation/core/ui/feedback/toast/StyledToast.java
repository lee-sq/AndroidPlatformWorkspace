...
public final class StyledToast {
    ...
    public static void clearLastToast(@NonNull Toast toast) {
        if (lastToast == toast) {
            lastToast = null;
        }
    }
    ...
    public static Toast warning(
        ...
        return custom(
                ...
                StyledToastUtils.getDrawable(context, R.drawable.foundation_toast_ic_error_outline_white_24dp),
                StyledToastUtils.getColor(context, R.color.foundation_toast_warning),
                StyledToastUtils.getColor(context, R.color.foundation_toast_text),
                duration,
                withIcon,
                true
        );
    ...
    public static Toast info(
        ...
        return custom(
                context,
                context.getString(message),
                StyledToastUtils.getDrawable(context, R.drawable.foundation_toast_ic_info_outline_white_24dp),
                StyledToastUtils.getColor(context, R.color.foundation_toast_info),
                StyledToastUtils.getColor(context, R.color.foundation_toast_text),
                duration,
                withIcon,
                true
    ...
    public static Toast success(
        ...
        return custom(
                context,
                context.getString(message),
                StyledToastUtils.getDrawable(context, R.drawable.foundation_toast_ic_check_white_24dp),
                StyledToastUtils.getColor(context, R.color.foundation_toast_success),
                StyledToastUtils.getColor(context, R.color.foundation_toast_text),
                duration,
                withIcon,
                true
    ...
    public static Toast error(
        ...
        return custom(
                context,
                context.getString(message),
                StyledToastUtils.getDrawable(context, R.drawable.foundation_toast_ic_clear_white_24dp),
                StyledToastUtils.getColor(context, R.color.foundation_toast_error),
                StyledToastUtils.getColor(context, R.color.foundation_toast_text),
                duration,
                withIcon,
                true
    ...
    public static Toast custom(
        ...
        return custom(
                context,
                context.getString(message),
                StyledToastUtils.getDrawable(context, iconRes),
                StyledToastUtils.getColor(context, tintColorRes),
                StyledToastUtils.getColor(context, R.color.foundation_toast_text),
                duration,
                withIcon,
                shouldTint
    ...
    public static Toast custom(
        ...
        return custom(
                ...
                icon,
                StyledToastUtils.getColor(context, tintColorRes),
                StyledToastUtils.getColor(context, textColorRes),
                duration,
                withIcon,
                shouldTint
        );
    ...
    public static Toast custom(
        ...
        final ImageView toastIcon = toastLayout.findViewById(R.id.foundation_toast_icon);
        final TextView toastTextView = toastLayout.findViewById(R.id.foundation_toast_text);
        Drawable drawableFrame;

        if (shouldTint) {
            drawableFrame = StyledToastUtils.tint9PatchDrawableFrame(context, tintColor);
        } else {
            drawableFrame = StyledToastUtils.getDrawable(context, R.drawable.foundation_toast_frame);
        }
        StyledToastUtils.setBackground(toastLayout, drawableFrame);
        ...
        if (withIcon) {
            ...
            StyledToastUtils.setBackground(toastIcon, tintIcon ? StyledToastUtils.tintIcon(icon, textColor) : icon);
        } else {
        ...
        currentToast.setGravity(
                toastGravity == -1 ? Gravity.TOP | Gravity.CENTER_HORIZONTAL : toastGravity,
                xOffset == -1 ? 0 : xOffset,
                yOffset == -1 ? context.getResources().getDimensionPixelSize(R.dimen.foundation_toast_top_offset) : yOffset
        );

        return currentToast;
    }

    private static Toast normalWithDarkThemeSupport(
            @NonNull Context context,
            @NonNull CharSequence message,
            Drawable icon,
            int duration,
    ...
    private static Toast withLightTheme(
            @NonNull Context context,
            @NonNull CharSequence message,
            Drawable icon,
            int duration,
        ...
        return custom(
                ...
                icon,
                StyledToastUtils.getColor(context, R.color.foundation_toast_text),
                StyledToastUtils.getColor(context, R.color.foundation_toast_normal),
                duration,
                withIcon,
                true
        );
    ...
    private static Toast withDarkTheme(
            @NonNull Context context,
            @NonNull CharSequence message,
            Drawable icon,
            int duration,
    ...
    public static final class Config {
        private Typeface typeface = StyledToast.currentTypeface;
        private int textSize = StyledToast.textSize;

        private boolean tintIcon = StyledToast.tintIcon;
        private boolean allowQueue = true;
        private int toastGravity = StyledToast.toastGravity;
        private int xOffset = StyledToast.xOffset;
        private int yOffset = StyledToast.yOffset;
        ...
        public static void reset() {
            StyledToast.currentTypeface = LOADED_TOAST_TYPEFACE;
            StyledToast.textSize = 16;
            StyledToast.tintIcon = true;
            StyledToast.allowQueue = true;
            StyledToast.toastGravity = -1;
            StyledToast.xOffset = -1;
            StyledToast.yOffset = -1;
            StyledToast.supportDarkTheme = true;
            StyledToast.isRTL = false;
        }
        ...
        public void apply() {
            StyledToast.currentTypeface = typeface;
            StyledToast.textSize = textSize;
            StyledToast.tintIcon = tintIcon;
            StyledToast.allowQueue = allowQueue;
            StyledToast.toastGravity = toastGravity;
            StyledToast.xOffset = xOffset;
            StyledToast.yOffset = yOffset;
            StyledToast.supportDarkTheme = supportDarkTheme;
            StyledToast.isRTL = isRTL;
        }
    }
}
